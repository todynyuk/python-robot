...
Variables    ../../page_objects/wallet_page_locators.py
Variables    ../../page_objects/messaging_with_seller_page_locators.py
Variables    ../../page_objects/seller_page_locators.py
...
MyWalletElementsTest
    [Tags]  MyWalletElements
    launchingBrowser    ${URL}   ${BROWSER_CHROME}
    login_Service
    click element    ${my_wallet_link}
    element should be enabled    ${add_card_button}
    click element    ${add_card_button}
    element should be enabled    ${card_form}
    element should be enabled    ${card_number_input_field}
    element should be enabled    ${month_input_field}
    element should be enabled    ${year_input_field}
    element should be enabled    ${cvv_input_field}
    element should be enabled    ${submit_button}

MessagingWithSellerTest
    [Tags]  MessagingWithSeller
    launchingBrowser    ${URL}   ${BROWSER_CHROME}
    login_Service
    click element    ${messaging_with_seller_link}
    element should be enabled    ${messages_form}
    element should be enabled    ${messages_sidebar}
    click element    (//button[@class='messages-chat'])[2]
    element should be enabled    ${chat_attachments_button}
    element should be enabled    ${chat_message_input_field}
    element should be enabled    ${send_message_button}
...
CheckSellerPageTest
    ...
    element should be enabled    ${messages_form}
    element should be enabled    ${messages_sidebar}
    ${seller_name}  get text    (//span[@class='messages-chat__seller'])[3]
    element should be enabled    ${seller_page_link}
    click element    ${seller_page_link}
    element should be enabled    ${seller_page_main_text}
    ${seller_page_h1_text}  get text    ${seller_page_main_text}
    should contain    ${seller_page_h1_text}    ${seller_name}
